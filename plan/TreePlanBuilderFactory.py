...
class TreePlanBuilderParameters:
    ...
    def __init__(
        self,
        builder_type: TreePlanBuilderTypes = DefaultConfig.DEFAULT_TREE_PLAN_BUILDER,
...
class IterativeImprovementTreePlanBuilderParameters(TreePlanBuilderParameters):
    ...
    def __init__(
        ...
        super().__init__(
            TreePlanBuilderTypes.LOCAL_SEARCH_LEFT_DEEP_TREE, cost_model_type
        )
    ...
    def create_tree_plan_builder(tree_plan_params: TreePlanBuilderParameters):
        ...
        if (
            ...
            return IterativeImprovementLeftDeepTreeBuilder(
                tree_plan_params.cost_model_type,
        ...
        raise Exception(
            "Unknown tree plan builder type: %s" % (tree_plan_params.builder_type,)
        )
