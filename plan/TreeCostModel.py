...
class IntermediateResultsTreeCostModel(TreeCostModel):
    ...
    def get_plan_cost(self, pattern: Pattern, plan: TreePlanNode):
        ...
        _, _, cost = IntermediateResultsTreeCostModel.__get_plan_cost_aux(
            plan, selectivity_matrix, arrival_rates, pattern.window.total_seconds()
        )
        return cost

    @staticmethod
    def __get_plan_cost_aux(
        tree: TreePlanNode,
        ...
        if isinstance(tree, TreePlanLeafNode):
            cost = pm = (
                time_window
                * arrival_rates[tree.event_index]
        ...
        (
            ...
            left_pm,
            left_cost,
        ) = IntermediateResultsTreeCostModel.__get_plan_cost_aux(
            tree.left_child, selectivity_matrix, arrival_rates, time_window
        )
        ...
        (
            ...
            tree.right_child, selectivity_matrix, arrival_rates, time_window
        )
