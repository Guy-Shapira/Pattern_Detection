    ...
    structural_test_pattern = Pattern(
        KleeneClosureOperator(
            SeqOperator(
                [
                    KleeneClosureOperator(
                        PrimitiveEventStructure("GOOG", "a"), min_size=3, max_size=5
                    ),
                    KleeneClosureOperator(PrimitiveEventStructure("GOOG", "b")),
                ]
            ),
    ...
    structural_test_pattern = Pattern(
        AndOperator(
            [
                ...
                SeqOperator(
                    [
                        ...
                        AndOperator(
                            [
                                KleeneClosureOperator(
                                    PrimitiveEventStructure("GOOG", "h")
                                ),
                                KleeneClosureOperator(
                                    SeqOperator(
                                        [
                                            PrimitiveEventStructure("GOOG", "i"),
                                            PrimitiveEventStructure("GOOG", "j"),
                                        ]
                                    ),
                                ),
                            ]
                ...
                PrimitiveEventStructure("GOOG", "k"),
                PrimitiveEventStructure("GOOG", "l"),
            ]
        ),
        AndFormula(
            SmallerThanFormula(
...
def MinMax_0_TestKleeneClosure(createTestFile=False):
    pattern = Pattern(
        SeqOperator(
            [
                KleeneClosureOperator(
                    PrimitiveEventStructure("GOOG", "a"), min_size=1, max_size=2
                )
            ]
        ),
        GreaterThanFormula(
            IdentifierTerm("a", lambda x: x["Opening Price"]), AtomicTerm(0)
        ),
        timedelta(minutes=5),
    )
...
def MinMax_2_TestKleeneClosure(createTestFile=False):
    pattern = Pattern(
        SeqOperator(
            [
                KleeneClosureOperator(
                    PrimitiveEventStructure("GOOG", "a"), min_size=4, max_size=5
                )
            ]
        ),
        GreaterThanFormula(
